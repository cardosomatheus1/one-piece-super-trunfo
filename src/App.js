...
class App extends React.Component {
  cardList =localStorage.getItem('saveCard') 
    ? JSON.parse(localStorage.getItem('saveCard')) : [];

  temTrunfo = localStorage.getItem('trunfo') 
    ? JSON.parse(localStorage.getItem('trunfo')) : false;
  ...
  onSaveButtonClick = (event) => {
    ...
    const { cardAttr1, cardAttr2, cardAttr3, cardName, cardDescription,
      cardRare, cardTrunfo, cardImage, hasTrunfo, savedCard,numberCards } = this.state;
    const newCard = {
      cardName,
      cardDescription,
      cardAttr1,
...
componentDidMount() {
  ...
  render() {
    const { cardName, cardDescription, cardAttr1, cardAttr2, cardAttr3,
      ...
      savedCard, filterName, filterRare, filterTrunfo, 
      filterAble, sortCard, positionCard, numberOfCards } = this.state;
    ...
    return (
      <div>
        <div className="header">
          ...
          <img className="logo1" 
          src="https://i.pinimg.com/564x/ec/78/f1/ec78f19f19347ffcf86c2f57177ecc30.jpg" />
        </div>
        {sortCard.length > 0
          ? <div className="game">
            <div className="game1">
            ...
            <div className="game2">
              <div className="cart">
                ...
                <img className="logo" src="https://i.pinimg.com/564x/ec/78/f1/ec78f19f19347ffcf86c2f57177ecc30.jpg" />
              </div>
